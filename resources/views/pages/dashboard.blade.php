...
<div class="container-fluid">
    ...
    <!-- Cards: Total Dokumen, Client, Biaya -->
    <div class="row">
            ...
            <div class="card shadow mb-4 border-0">
                <div class="card-header py-3 bg-white">
                    <h6 class="m-0 font-weight-bold text-primary">
                        Selamat Datang, {{ Auth::guard('web')->user()->full_name }}!
                    </h6>
                </div>
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted px-lg-5">
                        Kelola dokumen, client, dan biaya layanan kantor Anda dalam satu dashboard terintegrasi yang aman dan efisien.
                    </p>
        ...
        <div class="col-lg-4 mb-4">
            <div class="card shadow mb-4 border-0">
                ...
                <div class="card-body text-center">
                    <div class="mb-3">
                        <img class="img-profile rounded-circle border shadow-sm" style="width: 80px; height: 80px;" 
                             src="{{ asset('template/img/undraw_profile.svg') }}">
                    </div>
                    <p class="mb-1"><strong>{{ Auth::guard('web')->user()->full_name }}</strong></p>
                    <p class="mb-3">
